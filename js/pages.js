...
window.initLivePage = window.initLivePage || function() {
            if (!window._twitchInitDone && window._initTwitchOnce) {
              ...
              if (typeof Twitch !== 'undefined') {
                ...
                ts.src = 'https://player.twitch.tv/js/embed/v1.js';
                ts.onload = function() { window._initTwitchOnce(); };
                ts.onerror = function() { window._initTwitchOnce(); }; // shows fallback gracefully
...
(function() {
      ...
      <div class="mp-drop-type">${e.type||""}</div>`,
          ...
          // Expose era modal functions called from inline onclick in index.html / music.html
          window.openEraDetail = function(e) { openEraDetail(e); };
          window.closeEraModal = function() { closeEraModal(); };
          window.uploadEraPhoto = function(e, t) { uploadEraPhoto(e, t); };
          window.editEraField = function(e, t) { editEraField(e, t); };
          window.addEra = function() { addEra(); };
