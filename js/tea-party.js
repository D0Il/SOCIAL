...
(function() {
  function runTeaParty() {
    ...
    ! function() {
            ...
            e = this, t = function() {
                ...
                function w(e, t) {
                  return l(e) ? e.clone() : ((t = "object" == typeof t ? t : {}).date = e, t.args = arguments, new k(t))
                }
                var x = "$isDayjsObject",
                  $ = i;
                $.l = c, $.i = l, $.w = function(e, t) {
                  return w(e, {
                    locale: t.$L,
                    utc: t.$u,
                    x: t.$x,
                ...
                var k = ((i = B.prototype).parse = function(o) {
                    this.$d = function() {
                      var e = o.date,
                        t = o.utc;
                      ...
                      if ("string" == typeof e && !/Z$/i.test(e)) {
                        ...
                        if (i) {
                          ...
                          return t ? new Date(Date.UTC(i[1], n, i[3] || 1, i[4] || 0, i[5] || 0, i[6] || 0, a)) :
                    ...
                    function i(e, t) {
                      return e = $.w(a.$u ? Date.UTC(a.$y, t, e) : new Date(a.$y, t, e), a), o ? e : e.endOf(g)
                    }

                    function n(e, t) {
                      return $.w(a.toDate()[e].apply(a.toDate("s"), (o ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(t)),
                        a)
                    }
                    var a = this,
                      o = !!$.u(t) || t,
                    ...
                    var i = $.p(e),
                      n = "set" + (this.$u ? "UTC" : ""),
                      e = ((e = {})[g] = n + "Date", e[y] = n + "Date", e[v] = n + "Month", e[h] = n + "FullYear", e[
                        p] = n + "Hours", e[m] = n + "Minutes", e[u] = n + "Seconds", e[a] = n + "Milliseconds", e[
                        i]),
                      t = i === g ? this.$D + (t - this.$W) : t;
                    return i === v || i === h ? ((i = this.clone().set(y, 1)).$d[e](t), i.init(), this.$d = i.set(y,
                      Math.min(this.$D, i.daysInMonth())).$d) : e && this.$d[e](t), this.init(), this
                  }, i.set = function(e, t) {
                    ...
                    if (t === g) return e(1);
                    if (t === f) return e(7);
                    (e = {})[m] = 6e4, e[p] = 36e5, e[u] = 1e3, t = e[t] || 1, t = this.$d.getTime() + i * t;
                    return $.w(t, this)
                ...
                }, w.locale = c, w.isDayjs = l, w.unix = function(e) {
                  return w(1e3 * e)
                }, w.en = s[o], w.Ls = s, w.p = {}, w
              ...
              function() {
                ...
                e = this, t = function() {
                    ...
                    return function(v, e, h) {
                      ...
                      h.en.relativeTime = y, a.fromToBase = function(e, t, i, n, a) {
                        for (var o, r, s = i.$locale().relativeTime || y, l = v.thresholds || [{
                            l: "s",
                            r: 44,
                            d: "second"
                          }, {
                          ...
                          if (m <= u.r || !u.r) {
                            ...
                            a && (m = a("" + m)), r = "string" == typeof g ? g.replace("%d", m) : g(m, t, u.l, p);
                            break
                          }
                        }
                        if (t) return r;
                  ...
                  typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e ||
                    self).dayjs_plugin_relativeTime = t()
            ...
            e = window.FD_CFG.firebaseSdkBase, Promise.all([window.fdLoadScript(`${e}/firebase-app-compat.js`), window.fdLoadScript(`${e}/firebase-auth-compat.js`)]).then(() => {
              window.fdEnsureFirebaseApp(), firebase.auth().onAuthStateChanged(e => {
                e && "kbEeYQPq8TRtzHC2SfTizvbButa2" === e.uid ? L() : (B = !1, document.body.classList.remove(
                  "talk-admin"))
              })
            }).catch(e => console.warn("Early auth load failed:", e)), window.login = async function() {
              var e = prompt("Email:");
              if (e) {
            ...
            function ee() {
              document.body.classList.remove("force-desktop", "force-mobile"), "auto" !== a && document.body.classList.add(
                "force-" + a), document.body.classList.toggle("dark-mode", G)
            }
            ...
            function te() {
              ...
              o && (o.textContent = X("home")), r && (r.textContent = X("myProfile")), s && (s.textContent = X(
                "settings")), l && (l.textContent = X("writeBlog"));
              var d = R || {
                  username: "guest",
                  id: "guest"
                },
              ...
              e && (e.style.backgroundImage = `url('${c}')`), t && (t.textContent = d, t.title = "")
            }
            ...
            function ie() {
              if (P) {
                ...
                var e;
                t && document.activeElement !== t && (t.value = P.nickname || ""), i && document.activeElement !== i &&
                  (i.value = P.bio || ""), n && (e = P.avatarUrl || window.FD_CFG.defaultProfile.avatar, n.style.backgroundImage =
                    `url('${e}')`), a && (e = P.bannerUrl || c, a.style.backgroundImage = `url('${e}')`)
              }
            }
            ...
            function ae(t) {
              "userProfile" !== t && (Y = null), "hashtag" !== t && (W = null), "blogDetail" !== t && (window.viewingBlogId =
                null), "tweetDetail" !== t && (V = null, Z = !1);
              const i = {
              ...
              a && a.classList.toggle("view-profile", "userProfile" === t || "timeline" === t), document.querySelectorAll(
                ".talk-nav-pill").forEach(e => e.classList.remove("active")), "timeline" === t && document.getElementById(
                "nav-home")?.classList.add("active"), "userProfile" === t && document.getElementById(
                "talk-nav-profile")?.classList.add("active");
              const o = document.querySelector(".app-topbar");
              if (o) {
                let n = o.querySelector(".app-topbar-glass-bg");
                n || (n = document.createElement("div"), n.className = "app-topbar-glass-bg", o.insertBefore(n, o.firstChild)),
                  "userProfile" !== t && "timeline" !== t || setTimeout(() => {
                    var e = document.querySelector(".user-profile-banner");
                    const t = e ? e.style.backgroundImage : "";
                    let i = t ? t.replace(/url\(['"]?(.*?)['"]?\)/, "$1") : "";
                    !i && P && P.bannerUrl && (i = P.bannerUrl), i && (n.style.backgroundImage = `url('${i}')`)
                  }, 50)
              }
              oe(!0)
            }
            ...
            function u() {
              ...
              if (e) {
                ...
                t ? (e.innerHTML = `IMPORTANT! : ${he(t.title)}`, e.onclick = () => window.switchToBlog(t.id), e.classList
                  .add("active")) : e.classList.remove("active")
              }
            }
            ...
            function oe(e = !1) {
              ...
              var i = t.timeline && t.timeline.classList.contains("active") ? "timeline" : t.editProfile && t.editProfile
                .classList.contains("active") ? "editProfile" : t.userProfile && t.userProfile.classList.contains(
                  "active") ? "userProfile" : t.search && t.search.classList.contains("active") ? "search" : t.hashtag &&
                t.hashtag.classList.contains("active") ? "hashtag" : t.blogAdmin && t.blogAdmin.classList.contains(
                  "active") ? "blogAdmin" : t.blogDetail && t.blogDetail.classList.contains("active") ? "blogDetail" :
                t.blogList && t.blogList.classList.contains("active") ? "blogList" : t.trendingList && t.trendingList.classList
                .contains("active") ? "trendingList" : t.tweetDetail && t.tweetDetail.classList.contains("active") ?
                "tweetDetail" : "timeline";
              ...
              r && (r.style.background = "blogList" == i || "blogDetail" == i || "blogAdmin" == i ?
                "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.1)"), u(), "userProfile" == i && Y ? function(t, e = !1) {
                const i = M[t],
                  n = (i, document.getElementById("user-profile-content")),
                  a = document.getElementById("user-profile-timeline");
                var o, r, s, l;
                n && a && (o = i && i.nickname || t, r = i && i.avatarUrl || "https://i.imgur.com/ct2ERKN.jpeg", s =
                  i && i.bannerUrl || c, l = i && i.bio && i.bio.trim() || "", n.innerHTML =
                  `
  ...
  `,
                  ge(I.filter(e => e.username === t), a, null, e))
              }(Y, e) : "search" == i ? fe(e) : "hashtag" == i && W ? function(e, t = !1) {
                ...
                if (i && n && a) {
                  ...
                  n.textContent = `#${e}`, a.textContent = `${o.length} post${1===o.length?"":"s"}`, 0 === o.length ?
                    i.innerHTML = `<div class="search-no-results">No posts found with #${he(e)}</div>` : ge(o, i,
                      null, t)
                }
              }(W, e) : "timeline" == i ? de(I, e) : "blogDetail" == i && window.viewingBlogId ? function(t) {
                ...
                if (i && e) {
                  var {
                    nickname: n,
                    avatar: a
                  } = re(i.username), o = dayjs(i.created_at).format("MMMM D, YYYY [at] h:mm A");
                  const r = T.filter(e => e.blog_id === t).sort((e, t) => new Date(e.created_at) - new Date(t.created_at)),
                    s = B;
                  e.innerHTML =
                    `
  ...
  `;
                  ...
                  if (0 < r.length) {
                    const u = [...T].sort((e, t) => new Date(e.created_at) - new Date(t.created_at));
                    l.innerHTML = r.map(t => {
                      var e = t.username,
                        {
                          nickname: i,
      ...
      `
                  ...
                  window.editBlogPost = t => {
                    if (B) {
                      ...
                      if (e) {
                        O = t, document.getElementById("blog-title-input").value = e.title, document.getElementById(
                          "blog-content-input").value = e.content;
                        const i = document.querySelector("#view-blog-admin h2"),
                          n = document.getElementById("blog-submit-btn");
                        i && (i.textContent = "Edit Blog Post"), n && (n.textContent = "Update Blog Post"), ae(
                          "blogAdmin")
                      }
                    }
                  }, window.deleteBlogPost = async t => {
                    if (B && await ue(X("confirmDeleteBlog"))) try {
                      for (const e of T.filter(e => e.blog_id === t)) await E.delete(e.id);
                    ...
                    if (B) {
                      ...
                      if (e) try {
                        if (!e.is_pinned)
                          for (const i of C.filter(e => e.is_pinned && e.id !== t)) await k.update(i.id, {
                            is_pinned: !1
                          });
                        await k.update(t, {
                        ...
                        console.error("Failed to toggle pin:", e), alert("Failed to update pin status.")
                      }
                    }
                    ...
                    if ((i || e) && await ue(X("confirmDeleteComment"))) try {
                      await E.delete(t)
                    } catch (e) {
              ...
              }(window.viewingBlogId) : "blogList" == i ? function() {
                ...
                if (e) {
                  ...
                  I.forEach(t => {
                    if (t.text) {
                      ...
                      if (e) {
                        const i = new Set(e.map(e => e.toLowerCase().replace("#", "")));
                        i.forEach(e => {
                          n[e] ? (n[e].count++, dayjs(t.created_at).isAfter(dayjs(n[e].lastTweet.created_at)) &&
                            (n[e].lastTweet = t)) : n[e] = {
                            count: 1,
                            lastTweet: t
                          }
                  ...
                  0 !== i.length ? e.innerHTML = i.map(([e, t]) => {
                      var i = t.lastTweet,
                        {
                          nickname: n,
                          avatar: a
    ...
    `
                    ...
                    `<li style="padding:40px; text-align:center; color:#8899a6; font-style:italic; background:#fff;">${X("noHashtagsYet")}</li>`
                }
              }() : "tweetDetail" == i && V && function(t, e = !1) {
                ...
                if (i && n) {
                  ...
                  if (s) {
                    ...
                    const c = [...I].sort((e, t) => new Date(e.created_at) - new Date(t.created_at));
                    i.innerHTML = l ? me(l, c) :
                      '<div style="padding:20px; text-align:center; color:#666;">This tweet or its conversation root has been deleted.</div>',
                      pe(i);
                    const u = I.filter(e => e.parent_id === d).sort((e, t) => new Date(e.created_at) - new Date(t.created_at));
                    n.innerHTML = u.map(e => function t(i, n, a, o = 0) {
                      const e = n.find(e => e.id === i);
                      if (!e) return "";
                      const r = me(e, a);
                      const s = n.filter(e => e.parent_id === i).sort((e, t) => new Date(e.created_at) - new Date(
                        t.created_at));
                      let l = "";
                      0 < s.length && (l =
                        `<div class="reply-nest">
      ${s.map(e=>t(e.id,n,a,o+1)).join("")}
    </div>`);
                      return `<div class="thread-node">${r}${l}</div>`
                    }(e.id, I, c)).join(""), pe(n);
                    const m = d === t ? i.querySelector(".tweet") : n.querySelector(`[data-id="${t}"]`);
                    m && (e || t !== ve) && (m.style.backgroundColor = G ? "#1d2a35" : "#fff9d6", e && setTimeout(() => {
                      m.scrollIntoView({
                        behavior: "smooth",
                        block: "center"
                      })
                    }, 50)), ve = t, a && (F || !Z ? a.style.display = "none" : (a.style.display = "block", s = s.username,
                      o.textContent = `${X("replyingTo")} @${s}`, r.dataset.lastParent !== t && (r.value = "", r.dataset
                        .lastParent = t, r.dispatchEvent(new Event("input")))))
                  } else i.innerHTML =
                    '<div style="padding:20px; text-align:center; color:#666;">This tweet has been deleted.</div>', a &&
            ...
            function re(t) {
              var e = M[t] || Object.values(M).find(e => e.username && e.username.toLowerCase() === t.toLowerCase());
              return {
            ...
            function se() {
              if (0 === C.length) return '<div style="font-size:11px; color:#888; text-align:center; padding:10px;">No blog posts yet.</div>';
              const e = [...C].sort((e, t) => new Date(t.created_at) - new Date(e.created_at));
              return e.map(e => {
                var {
                  nickname: t,
                  avatar: i
                } = re(e.username), n = dayjs(e.created_at).format("MMM D"), a = (e.content || "").replace(
                  /<[^>]*>/g, "").substring(0, 30);
                return `
    ...
    `
            ...
            function le() {
              ...
              t && (t.innerHTML = function() {
                ...
                const a = Object.entries(n).sort((e, t) => t[1] - e[1]).slice(0, 8);
                return 0 !== a.length ? a.map(([e, t]) =>
                    `
  ...
  `
            ...
            function de(t, i = !1) {
              ...
              if (n) {
                ...
                if (0 === e.length) {
                  ...
                  "hot" === K && (e = X("noHotPosts")), n.innerHTML =
                    `<li style="padding:40px; text-align:center; color:#8899a6; font-style:italic; background:#fff;">${e}</li>`
                } else ge(e, n, null, i)
              }
            }
            ...
            function ce(e, t) {
              if (!t) return e;
              t = he(t).replace(/[.*+?^${}()|[\\]\\\\]/g, "\\$&"), t = new RegExp(`(${t})(?![^<]*>)`, "gi");
            ...
            function ue(l) {
              return new Promise(t => {
                ...
                const o = e => {
                    i.classList.remove("active"), n.removeEventListener("click", r), a.removeEventListener("click",
                      s), t(e)
                  },
                  r = () => o(!0),
                  s = () => o(!1);
            ...
            function me(t, e, i = null) {
              if (!t) return "";
              const n = R.username;
              var a = t.created_at && dayjs().diff(dayjs(t.created_at), "second") < 8 ? "new-tweet-anim" : "";
              let o = t;
              var r = !!t.retweet_of,
                s = null;
              let l = "";
              r && (s = t.username, p = I.find(e => e.id === t.retweet_of), o = p || { ...t,
                text: `[${X("nothingToSee")}]`
              }, g = M[s], l = g && g.nickname || s);
              ...
              let f = ye(he(o.text || ""));
              i && (f = ce(f, i));
              s = o.mediaUrl || o.imageUrl || null, c = o.mediaType || (o.imageUrl ? "image" : null);
              let v = "";
              !o.quote_id || (y = I.find(e => e.id === o.quote_id)) && (i = re(y.username), b = y.mediaUrl || y.imageUrl,
                w = y.mediaType || (y.imageUrl ? "image" : null), v =
                `
      ...
      `
              ...
              let h = "";
              o.parent_id && ($ = (x = I.find(e => e.id === o.parent_id)) ? x.username : "someone", h =
                `
  ...
  `
            ...
            function pe(e) {
              ...
              e.querySelectorAll(".tweet-like-btn").forEach(e => {
                e.addEventListener("click", async e => {
                  ...
                  e ? await $.delete(e.id) : await $.create({
                    tweet_id: t
                  })
                })
                ...
                e.addEventListener("click", async e => {
                  ...
                  if ("cancel" !== e)
                    if ("normal" === e)
                      if (I.some(e => e.retweet_of === t && e.username === i)) alert(
                        "You already retweeted this!");
                      else try {
                        await x.create({
                          retweet_of: t,
                          text: ""
                ...
                e.addEventListener("click", async e => {
                  ...
                  if (await ue(X("confirmDeleteTweet"))) try {
                    await x.delete(e), V === e && window.switchToHome()
                  } catch (e) {
                    console.error("Delete failed:", e), alert(
                      "Failed to delete tweet. Note: You can only delete your own posts.")
                  }
                })
                ...
                const i = t.querySelector("video, audio"),
                  ...
                  l = async () => {
                    try {
                      var e;
                      i.paused ? (void 0 !== (e = i.play()) && await e, n.classList.add("playing"), t.classList.add(
                        "is-playing")) : (i.pause(), n.classList.remove("playing"))
                    } catch (e) {
                ...
                i.ontimeupdate = () => {
                  var e;
                  i.duration && (e = i.currentTime / i.duration * 100, o.style.width = `${e}%`, d && (d.style.left =
                    `${e}%`)), r.textContent = (e => {
                ...
                var p = e => {
                  e.stopPropagation(), c = !0, u = !i.paused, u && (i.pause(), n.classList.remove("playing")), m(
                    e), window.addEventListener("mousemove", g), window.addEventListener("mouseup", f), window.addEventListener(
                    "touchmove", g), window.addEventListener("touchend", f)
                };
                const g = e => {
                    c && m(e)
                  },
                  f = async e => {
                    if (c) {
                      ...
                      window.removeEventListener("mousemove", g), window.removeEventListener("mouseup", f), window.removeEventListener(
                        "touchmove", g), window.removeEventListener("touchend", f)
                    }
                  };
                a.addEventListener("mousedown", p), a.addEventListener("touchstart", p, {
                  passive: !1
                });
                const v = () => {
                  var e = 100 * s.value;
                ...
                }, s.onclick = e => e.stopPropagation(), s.onmousedown = e => e.stopPropagation(), i.onended = () => {
                  n.classList.remove("playing"), t.classList.remove("is-playing"), o.style.width = "0%"
                }
              }), e.querySelectorAll(".tweet").forEach(t => {
                t.addEventListener("click", e => {
                  e.target.closest("button, a, .clickable-user, .custom-player") || (e.target.classList.contains(
                      "tweet") || e.target.classList.contains("tweet-body") || e.target.closest(".tweet-text")) &&
            ...
            function ge(i, n, a = null, o = !1) {
              if (i && n) {
                ...
                let e = 0;
                !o && d && (e = Math.floor(d.scrollTop / j) - 10), e = Math.max(0, Math.min(e, Math.max(0, q.length - D)));
                ...
                t += c.map(e => me(e, l, a)).join(""), t +=
                  `<div class="list-spacer" style="height: ${i}px; pointer-events: none;"></div>`, z ? t +=
                  ...
                  !N && 0 < q.length && ("latest" === K || document.getElementById("view-user-profile").classList.contains(
                    "active")) && (t +=
                    `<li style="padding: 20px; text-align: center; color: #8899a6; font-size: 11px; background: #fff; border-top: 1px solid var(--border);">You've reached the beginning of time.</li>`
                  ), n.innerHTML = t, pe(n), o && d && (d.scrollTop = 0)
              }
            }
            ...
            function fe(t = !1) {
              ...
              if (i) {
                ...
                if ("users" === g && "all" === f ? n.textContent = "All Users Directory" : n.textContent = p ?
                  `Results for "${p}"` : "Search Twitter", window.innerWidth <= 640) {
                  let e = document.querySelector(".search-page-input-container");
                  if (!e) {
                    e = document.createElement("div"), e.className = "search-page-input-container", e.innerHTML =
                      `
      ...
      `,
                ...
                if (e.classList.toggle("active", "tweets" === g), a.classList.toggle("active", "users" === g), o.style.display =
                  "users" === g ? "block" : "none", r.classList.toggle("active", "normal" === f), s.classList.toggle(
                    "active", "exact" === f), l.classList.toggle("active", "all" === f), p || "all" === f)
                  if ("tweets" === g) {
                    let e = I;
                    ...
                    if (d) {
                      const $ = m(d[1]);
                      $.isValid() && (e = e.filter(e => dayjs(e.created_at).isBefore($.startOf("day"))))
                    }
                    if (c) {
                      const k = m(c[1]);
                    ...
                    const x = p.replace(/before:\d{1,2}-\d{1,2}-\d{4}/gi, "").replace(/after:\d{1,2}-\d{1,2}-\d{4}/gi,
                      "").replace(/during:\d{1,2}-\d{1,2}-\d{4}/gi, "").trim();
                    x && (e = e.filter(e => e.text && e.text.toLowerCase().includes(x.toLowerCase()))), 0 === e.length ?
                      i.innerHTML = `<div class="search-no-results">No tweets found matching "${he(p)}"</div>` : ge(e,
                        i, "all" === f ? null : x || p, t)
                  } else {
                    q = [];
                    t = new Set([...Object.keys(M), ...I.map(e => e.username)]);
                    const B = Array.from(t).map(e => {
                      var t = M[e];
                      return {
                        username: e,
                    ...
                    }).filter(e => "all" === f || ("exact" === f ? e.username.toLowerCase() === p.toLowerCase() : e.username
                      .toLowerCase().includes(p.toLowerCase()) || e.nickname.toLowerCase().includes(p.toLowerCase())
                    )).sort((e, t) => e.hasSignedUp !== t.hasSignedUp ? t.hasSignedUp - e.hasSignedUp : e.username.localeCompare(
                      t.username));
                    0 === B.length ? i.innerHTML =
                      `<div class="search-no-results">No users found matching "${he(p)}"</div>` : ("users" === g &&
                        "all" === f && (n.textContent = `${X("allUsersDirectory")} (${B.length} total)`), i.innerHTML =
                        B.map(e => {
                          ...
                          return t ? n = ce(he(t), v) : (n = "No bio - click to view profile", a +=
      ...
      `
            ...
            window.switchView = ae, window.switchToBlog = e => {
            ...
            function ye(e) {
              ...
              return t = t.replace(/(^|\s)@([a-zA-Z0-9_]+)/g, (e, t, i) => {
              ...
              ee(),
                function() {
                  ...
                  e && (e.textContent = X("confirm")), t && (t.textContent = X("delete")), i && (i.textContent = X(
                    "cancel"));
                  ...
                  n && (n.textContent = X("retweet")), a && (a.textContent = X("retweetChoiceDesc")), o && (o.textContent =
                    X("retweetNormally")), r && (r.textContent = X("quotePost")), s && (s.textContent = X("cancel"))
                }();
              ...
              window._saveSiteConfig = async function(e) {
                if (document.body.classList.contains("talk-admin")) try {
                  await o.set(e, {
                    merge: !0
                  })
                } catch (e) {}
                ...
                if (e) {
                  if (e.crop_positions && (_cropPositions = e.crop_positions), e.crop_saturation && (_cropSaturation =
                    ...
                    try {
                      ...
                      if (r && (r.textContent = S.profile.bio || ""), S.profile.followerCounts) {
                  ...
                  if (e.settings && (S.settings = Object.assign(S.settings || {}, e.settings), "function" == typeof applyAccent &&
                      applyAccent(S.settings.accent), S.settings.customBg ? (document.documentElement.style.backgroundImage =
                        `url('${S.settings.customBg}')`, document.body.style.backgroundImage =
                        `url('${S.settings.customBg}')`, "function" == typeof _applyCustomBgUI && _applyCustomBgUI(S.settings
                          .customBg)) : "function" == typeof _applyCustomBgUI && _applyCustomBgUI("")), e.insta_posts &&
                    e.insta_posts.length) {
                    const l = document.getElementById("grid-gallery");
                    l && (l.innerHTML = e.insta_posts.map(e =>
                        `
      ...
      <button class="insta-cell-delete" onclick="event.preventDefault();event.stopPropagation();deleteInstaCell(this,'${e.alt}')" title="Remove">✕</button>
            ...
            <div class="cell-ov"><div class="cell-stat"><svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>View</div></div>
                      ...
                      ).join(""), "function" == typeof applyAllCrops && applyAllCrops(), "function" == typeof wireInstaClickCrop &&
                      wireInstaClickCrop())
                  }
                  if (e.pinned) try {
              ...
              a.onAuthStateChanged(async e => {
                if (e && "kbEeYQPq8TRtzHC2SfTizvbButa2" === e.uid) {
                  ...
                  try {
                    ...
                    t && (n.pinned = t), await o.set(n, {
                      merge: !0
                    })
                  } catch (e) {}
                  if (y) try {
                    var i = await y.filter({
                      username: "famed0ll"
                    }).getList();
                    P = 0 < i.length ? i[0] : await y.create({
                      nickname: "Fame Doll",
                      bio: "",
                      avatarUrl: "",
                      bannerUrl: ""
              ...
              class s {
                ...
                subscribe(t) {
                  return this._col.orderBy("created_at", "desc").onSnapshot(e => t(e.docs.map(e => ({
                    id: e.id,
                    ...e.data()
                ...
                filter(e) {
                  ...
                  return Object.entries(e).forEach(([e, t]) => {
                    ...
                    subscribe(t) {
                      return i.onSnapshot(e => t(e.docs.map(e => ({
                        id: e.id,
                        ...e.data()
              ...
              x = h.collection(m), y = h.collection(p), $ = h.collection(g), k = h.collection(f), E = h.collection(v),
                B || (F = !0, R = {
                  username: "guest",
                  id: "guest"
                  ...
                  C = e, le(), oe(), window.updateLatestPostWidget && window.updateLatestPostWidget(e)
                }), E.subscribe(e => {
                  T = e, oe()
                }),
                function() {
  ...
  `
                ...
                function() {
                  ...
                  function p() {
                    var e;
                    J ? (n.style.display = "flex", a.textContent = J.handle) : n.style.display = "none", U ? (e = I.find(
                        e => e.id === U), o.style.display = "flex", r.textContent = e ? e.username : "someone") : o.style
                      .display = "none"
                  }
                  ...
                  t && t.addEventListener("change", () => {
                    ...
                    if (e && e.size > w) return alert("File is too large. Max size is 25MB."), void(t.value = "");
                        ...
                        if (i && !(i.length > b)) {
                          ...
                          try {
                            const a = document.getElementById("imgur-url-input"),
                              o = a ? a.value.trim() : "";
                            o ? (e = o.replace(/^https?:\/\/imgur\.com\/([a-zA-Z0-9]+)$/,
                              "https://i.imgur.com/$1.jpg"), t = "image") : u && (t = u.type.startsWith("video/") ?
                              "video" : u.type.startsWith("audio/") ? "audio" : "image", e = await window._uploadFile(
                                u));
                            await x.create({
                              text: i,
                              mediaUrl: e,
                            ...
                            l && (l.value = ""), J = null, U = null, p(), u = null, a && (a.value = "");
                            const r = document.getElementById("imgur-url-wrapper");
                            r && (r.style.display = "none");
                            const s = document.getElementById("imgur-toggle-btn");
                            s && (s.style.borderColor = "", s.style.color = ""), c && (c.textContent = "")
                          } catch (e) {
                            console.error("Error creating tweet:", e), alert("Failed to post. Please try again.")
                          } finally {
                    ...
                    if (B) {
                      ...
                      try {
                        O ? (await k.update(O, {
                          title: e,
                          content: t
                        }), O = null) : await k.create({
                          title: e,
                          content: t
                        }), f.value = "", v.value = "";
                        const n = document.querySelector("#view-blog-admin h2");
                        n && (n.textContent = "Create New Blog Post"), h.textContent = "Publish Blog Post", ae(
                          "timeline")
                      } catch (e) {
                        console.error("Blog publish error:", e), alert(
                ...
                function() {
                  ...
                  if (r) {
                    ...
                    r.addEventListener("input", c), l.addEventListener("change", () => {
                      var e = l.files && l.files[0];
                      if (e && e.size > w) return alert("File is too large. Max size is 25MB."), void(l.value = "");
                        ...
                        if (B) {
                          ...
                          if (i && !(i.length > b) && V) {
                            ...
                            let e = null,
                              t = "image";
                            try {
                              a && (t = a.type.startsWith("video/") ? "video" : a.type.startsWith("audio/") ?
                                "audio" : "image", e = await window._uploadFile(a)), await x.create({
                                text: i,
                                mediaUrl: e,
                                mediaType: t,
                                parent_id: V
                              }), r.value = "", a = null, l.value = "", d.textContent = ""
                            } catch (e) {
                              console.error("Error creating reply:", e), alert("Failed to post reply.")
                            } finally {
                ...
                function() {
                  ...
                  i.addEventListener("change", e => {
                    e = e.target.files[0];
                    if (e) {
                      if (e.size > w) return alert("Profile picture must be under 4MB."), void(i.value = "");
                      l = e;
                    ...
                    e = e.target.files[0];
                    if (e) {
                      if (e.size > w) return alert("Banner image must be under 4MB."), void(n.value = "");
                      d = e;
                      const t = new FileReader;
                      t.onload = e => {
                    ...
                    if (P) {
                      ...
                      try {
                        ...
                        i && i.value.trim() ? e = i.value.trim() : l && (e = await window._uploadFile(l));
                        let t = P.bannerUrl;
                        const n = document.getElementById("profile-banner-url-input");
                        n && n.value.trim() ? t = n.value.trim() : d && (t = await window._uploadFile(d)), await y.update(
                            P.id, {
                              nickname: a.value,
                              bio: o.value,
                              avatarUrl: e,
                              bannerUrl: t
                            }), P.nickname = a.value, P.bio = o.value, P.avatarUrl = e, P.bannerUrl = t, te(),
                ...
                function() {
                  ...
                  window.switchToProfile = e => {
                    ...
                    e && e.startsWith("#") && 1 < e.length ? window.switchToHashtag(e) : (Q = { ...Q,
                      query: e,
                      type: t
                    }, ae("search"))
                  }, window.showRetweetChoice = e => new Promise(t => {
                    ...
                    const e = e => {
                      i.classList.remove("active"), n.onclick = null, a.onclick = null, o.onclick = null, t(e)
                    };
                    n.onclick = () => e("normal"), a.onclick = () => e("quote"), o.onclick = () => e("cancel")
                  ...
                  const l = document.querySelector(".app-column-right .sidebar-section-header:first-of-type");
                  l && (l.textContent = X("twitterBlog"), l.onclick = () => ae("blogList"));
                  const d = document.querySelector(".app-column-right .sidebar-section-header:last-of-type");
                  d && (d.textContent = X("trendingHashtags"), d.onclick = () => ae("trendingList"));
                  const c = document.querySelector(".app-column-right .sidebar-section-header:last-of-type");
                  ...
                  document.addEventListener("click", e => {
                    ...
                    t && ("#" === t.getAttribute("href") || t.getAttribute("onclick")) && window.scrollTo({
                      top: 0,
                      behavior: "smooth"
                    })
                  });
              ...
              l && l.addEventListener("scroll", () => {
                ...
                var t, i, n;
                e && (t = e.id, i = l.scrollTop + l.clientHeight >= l.scrollHeight - 800, n = "view-timeline" ===
                  t && "latest" === K || "view-user-profile" === t, i && n && async function() {
                    if (!z && N) {
                      z = !0, oe();
                      var e = I.length;
                      H += 1e3;
                  ...
                  }(), "view-search" === t && "users" === Q.type || !["view-timeline", "view-following",
                    "view-user-profile", "view-hashtag", "view-search", "view-trending-list"
                  ].includes(t) || (i = e.querySelector(".timeline-list")) && q.length > D && (n = l.scrollTop, n =
                    Math.floor(n / j) - 10, n = Math.max(0, Math.min(n, q.length - D)), 10 <= Math.abs(n - A) &&
                    ge(q, i, "view-search" === t ? Q.query : null, !1)))
              }), e = e => {
                e.forEach(e => {
                  M[e.username] = e
                }), R && M[R.username] && (P = M[R.username]), oe(), te(), ie()
              };
              try {
                e(await y.getList({
                  limit: 1e4
              ...
              try {
                var d = await y.filter({
                  username: R.username
                }).getList();
                0 < d.length ? P = d[0] : "guest" !== R.username && (P = await y.create({
  ...
  if (document.getElementById('app-root')) {
    ...
    window._onPageLoad = function(pageName) {
      if (prevHook) try { prevHook(pageName); } catch(e) {}
