  ...
  function renderStreams() {
    ...
    if (sidebarList) {
      ...
      demosLink.innerHTML =
        ...
        _streamIconSvg(
          'demos',
          '<svg viewBox="0 0 24 24"><path d="M1.175 12.225c-.015 0-.03.01-.03.025l-.338 2.4.338 2.325c0 .015.015.025.03.025s.03-.01.03-.025l.383-2.325-.383-2.4c0-.015-.015-.025-.03-.025z"/></svg>',
        ) +
